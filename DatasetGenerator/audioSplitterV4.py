...
if(r.ok):
    ...
    for keypress in keypressArray:
        ...
        if(mappedKey == "."):
            mappedKey = "FullStop"
        elif(mappedKey == "!" or mappedKey == "1" or mappedKey == "2" or mappedKey == "3" or mappedKey == "4" or mappedKey == "5" or mappedKey == "6" or mappedKey == "7" or mappedKey == "8" or mappedKey == "9" or mappedKey == "0"):
            continue
        elif(mappedKey == "\\"):
        ...
        tfm.build_file('./InputAudioFiles/' + FILE_NAME,
                       './SplitAudioFiles/temp.wav')
        ...
        normalized_chunk.export(
            './SplitAudioFiles/' + mappedKey + '/' + mappedKey +
            '_' + time.strftime("%d-%m-%Y_%H:%M%:%S:%f") + '.wav',
            bitrate="192k",
            format="wav"
        )
