...
pipe = make_pipeline(StandardScaler(), KNeighborsClassifier(),verbose=True)
pipe.fit(X_outer_train, y_outer_train)  # apply scaling on training data

print(pipe.score(X_outer_test, y_outer_test))
